          ...
          <div className={`${s.findedClientContainer} `}>
            <ul className={`d-flex flex-column ${s.findedClientsList} `}>
                <div className={`d-flex justify-content-between align-items-center `}>
                    <li className={`text-truncate flex-grow-1 me-5 ${s.name} fs-6`}>Adrian Estrada</li>
                ...
                <div className={`d-flex justify-content-center align-items-center `}>
                    <li className={`text-truncate flex-grow-1 me-5 ${s.name} fs-6`}>Miguel Orozo</li>
                ...
                <div className={`d-flex justify-content-center align-items-center `}>
                    <li className={`text-truncate flex-grow-1 me-5 ${s.name} fs-6` }>Santiago Rojas</li>
